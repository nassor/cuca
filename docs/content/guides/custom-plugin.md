...
a `CucaPlugin` at all. Five of the crate's seventeen non-provider features are not, and they live in the service tier; the reasoning is in [Plugins and services](@/concepts/plugin-layering.md).
